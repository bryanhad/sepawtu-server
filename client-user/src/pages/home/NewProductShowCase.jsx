export default function NewProductShowCase() {
  ...
  return (
    <div className="md:min-h-[80vh] w-full grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 px-6">
        <div className="w-full h-full max-md:max-h-[150px] overflow-hidden">
            <img className="w-full h-full object-cover lg:object-contain bg-gray-200 max-lg:opacity-[70%]" src={image1} alt="chucks front view" />
        </div>
        ...
        <div className="w-full overflow-hidden">
            <img className="w-full h-full max-md:max-h-[150px] object-cover lg:object-contain bg-gray-200 max-lg:opacity-[70%]" src={image2} alt="chucks side view" />
        </div>
    </div>
  )
}
